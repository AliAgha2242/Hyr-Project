...
namespace HYR_Blog.CoreLayer.Services.OrderService.Queries
{
    public interface IGetAllUserOrderService
    {
        MyResult<List<ShowOrderDto>> GetAllOrders(int id);
    }
    public class GetAllUserOrderService : IGetAllUserOrderService
    {
        private readonly HyrDbContext _dbContext;

        public GetAllUserOrderService(HyrDbContext dbContext)
        {
            _dbContext = dbContext;
        }

        public MyResult<List<ShowOrderDto>> GetAllOrders(int id)
        {
