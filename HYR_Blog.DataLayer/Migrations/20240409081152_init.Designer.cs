...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HYR_Blog.DataLayer.Entitys.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 11, 41, 51, 727, DateTimeKind.Local).AddTicks(8895));
            ...
            modelBuilder.Entity("HYR_Blog.DataLayer.Entitys.RequestPay", b =>
                {
            ...
            modelBuilder.Entity("HYR_Blog.DataLayer.Entitys.RequestPay", b =>
                {
                    b.HasOne("HYR_Blog.DataLayer.Entitys.Cart", "Cart")
                        .WithOne("RequestPay")
                        .HasForeignKey("HYR_Blog.DataLayer.Entitys.RequestPay", "CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
